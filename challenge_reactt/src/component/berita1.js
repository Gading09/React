...
class Berita1 extends Component{
    render(){
        return(
                ...
                <div className="col-md-12 kotak">
                    ...
                    <div className="col-md-12">
                        <div className="col-md-12 judul">
                            <p>7 Tanda-Tanda Kiamat Besar yang Sudah Terjadi di Zaman Rasul</p>
                        </div>
                        <div className="col-md-12 pendek">
                            <p>Mantee alterra kelapatan menunggu makanan tak kunjung datang</p>
                        </div>
